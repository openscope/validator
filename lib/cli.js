...
const OPTIONS = {
    /**
     * @memberOf OPTIONS
     * @property pathToAirportFile
     */
    pathToAirportFile: '',

    /**
     * @memberOf OPTIONS
     * @property pathToAirlineFile
     */
    pathToAirlineFile: PATHS.AIRLINES,
...
function cli() {
    ...
    if (_hasArg(args, 'a')) {
        ...
        OPTIONS.pathToAirportFile = path.join(process.cwd(), localPathToAirportFile);
    }

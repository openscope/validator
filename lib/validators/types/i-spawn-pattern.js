...
const IcaoType = require('./common-types').IcaoType;
const NumberTupleOrEmptyStringType = require('./common-types').NumberTupleOrEmptyStringType;
...
IBaseSpawnPattern.prototype.getAirlineAndFleet = function() {
    return false;
    // return this.airlines.map((airlineAndRate) => airlineAndRate[0]);
};

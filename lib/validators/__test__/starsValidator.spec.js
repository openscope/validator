...
const starWithKeyIcaoMismatchMock = {
    HAWKZ6: {
        icao: 'HAWKZ',
        name: 'Hawks Six',
        entryPoints: {
...
describe('StarsValidator', () => {
    ...
    describe('when procedure key does not match #icao property', () => {
        it('should return false', () => {
            const validator = new StarsValidator(starWithKeyIcaoMismatchMock, airportKseaMock.fixes);
        ...
        it('should return the correct error message', () => {
            ...
            expect(validator.errors[0].message).to.eq(ERROR_MESSAGE.PROCEDURE.KEY_ICAO_MISMATCH.STAR);
        });
    });

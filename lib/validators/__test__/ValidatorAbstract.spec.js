...
const airlinesMock = require('./_mock/airlinesMock');
...
class InvalidValidator extends ValidatorAbstract {
    constructor() {
        super('threeve', null);
    }
}
...
describe('ValidatorAbstract', () => {
    describe('invalid data', () => {
        it('should not throw with invalid data', () => {
            expect(() => new ValidatorAbstract()).to.not.throw();
        });

        it('should register an error when `#_json` is `undefined`', () => {
            const validator = new ValidatorAbstract('base');
        ...
        it('should register an error when `#_requiredKeys` is `undefined`', () => {
            const validator = new ValidatorAbstract('threeve', airportKseaMock);
    ...
    describe('valid data', () => {
        it('should not throw with valid data', () => {
            expect(() => new ValidatorAbstract('base', airportKseaMock)).not.to.throw();
        });
    ...
    describe('.validate()', () => {
        it('should throw', () => {
            const validator = new ValidatorAbstract();
    ...
    describe('when passed valid data', () => {
        describe('and `#_data` is an dict', () => {
            ...
            beforeEach(() => {
                sidsValidator = new SidsValidator(airportKseaMock.sids, airportKseaMock.fixes);
            });
            ...
            it('should call `.validateItem()` with each item in the dict', () => {
                ...
                expect(_validateItemSpy.callCount).to.eq(7);
            });
            ...
            it('should provide a contextual error message for the `#key` that failed', () => {
                ...
                const validator = new SidsValidator(invalidSidMock, airportKseaMock.fixes);
        ...
        describe('and `#_data` is an array', () => {
            ...
            beforeEach(() => {
                spawnPatternsValidator = new SpawnPatternsValidator(airportKseaMock.spawnPatterns, airlinesMock);
            });

...
const sidWithIncorrectKeyAndIcaoMock = {
    SUMMA1: {
        icao: 'SUMMA',
        name: 'Summa One',
        rwy: {
...
describe('SidsValidator', () => {
    ...
    describe('when procedure key does not match #icao property', () => {
        it('should return false', () => {
            const validator = new SidsValidator(sidWithIncorrectKeyAndIcaoMock, airportKseaMock.fixes);
        ...
        it('should return the correct error message', () => {
            ...
            expect(validator.errors[0].message).to.eq(ERROR_MESSAGE.PROCEDURE.KEY_ICAO_MISMATCH.SID);
        });
    });
    ...
    describe('when an undefined fix is present in a procedure', () => {
        ...
        it('should return the correct error message', () => {
            ...
            expect(validator.errors[0].message).to.eq(ERROR_MESSAGE.PROCEDURE.UNDEFINED_FIX.SID);
        });
    });
});

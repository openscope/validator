...
describe('AirwaysValidator', () => {
    ...
    describe('valid data', () => {
        it('should not throw with valid data', () => {
            expect(() => new AirwaysValidator(airportKseaMock.airways, airportKseaMock.fixes)).not.to.throw();
        });

        it('should return true', () => {
            const validator = new AirwaysValidator(airportKseaMock.airways, airportKseaMock.fixes);
